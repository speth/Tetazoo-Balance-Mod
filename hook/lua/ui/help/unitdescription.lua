...
#Cybran
	['drlk001'] = "<LOC Unit_Description_200001> Advanced Mobile Anti-Air unit. Utilizing a crude but effective target painter the Bouncer can lead it's missile salvo even to the fastest advanced aircraft. It can also use it's missiles as anti-ground rockets without guidance.",
	['drlk005'] = "<LOC Unit_Description_200005> Advanced Mobile Anti-Air unit. Utilizing a crude but effective target painter the Bouncer can lead it's missile salvo even to the fastest advanced aircraft. It can also use it's missiles as anti-ground rockets without guidance.",
#UEF
	['delk002'] = "<LOC Unit_Description_200002> Advanced Mobile Anti-Air unit. The Cougar is armed with dual high precision AA gatling cannons, capable of hitting even the faster high-end planes.",	
#Aeon
	['dalk003'] = "<LOC Unit_Description_200003> Advanced Mobile Anti-Air unit. The Redeemer carries safely inside it's covers a modified anti-air variant of the powerful Serpentine missile.",	
#Seraphim
	['dslk004'] = "<LOC Unit_Description_200004> Advanced Mobile Multipurpose unit. Using an uncontained power generator core the Uyanah can unleash powerful and swift lightning strikes at aerial targets. It can also generate a secondary flux to a grounded target.",
}
